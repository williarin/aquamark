...
Free Watermarks is a full-featured, professional solution for applying image watermarks to your media uploads. Built with a modern, robust architecture, it provides extensive control over the appearance and placement of your watermark, ensuring your brand is consistently represented across your site.
...
*   **Flexible Sizing**: Control the watermark's size with pixel (px) or percentage (%) based width and height. Supports auto-scaling based on width.
*   **Opacity Control**: Set the transparency of your watermark from 0% (fully transparent) to 100% (fully opaque).
*   **Advanced Blend Modes**: Go beyond simple overlays with Photoshop-like blend modes, including Normal, Multiply, Screen, and Overlay. These modes use pixel-by-pixel calculations for professional results.
